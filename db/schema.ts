...
export const hospitalCloudResources = sqliteTable("hospital_cloud_resources", {
  ...
  resource: text("resource", {
    enum: ["devices", "costEntries", "notifications", "improvementActions", "modules", "dataSources", "analysisProfiles", "ledgerFields", "metricDictionary", "metricCategories", "deviceReports", "reportFields", "chartTemplates", "metricCockpit", "deviceCockpit"],
  }).notNull(),
