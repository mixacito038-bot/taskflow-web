...
const monthlyTemplate = [
  { month: "1月", revenue: 138, cost: 104, utilization: 78.3 },
  { month: "2月", revenue: 118, cost: 97, utilization: 68.9 },
  { month: "3月", revenue: 149, cost: 108, utilization: 80.1 },
  { month: "4月", revenue: 154, cost: 111, utilization: 81.6 },
  { month: "5月", revenue: 160, cost: 114, utilization: 84.2 },
  { month: "6月", revenue: 158, cost: 113, utilization: 83.0 },
  { month: "7月", revenue: 166, cost: 117, utilization: 86.4 },
  { month: "8月", revenue: 170, cost: 118, utilization: 87.1 },
  { month: "9月", revenue: 161, cost: 114, utilization: 83.5 },
  { month: "10月", revenue: 164, cost: 116, utilization: 84.8 },
  { month: "11月", revenue: 162, cost: 114, utilization: 83.9 },
  { month: "12月", revenue: 172, cost: 121, utilization: 88.2 },
];

function scaledMonthly(revenueScale: number, costScale: number, utilizationDelta: number) {
  return monthlyTemplate.map((item) => ({
    ...item,
    revenue: Number((item.revenue * revenueScale).toFixed(1)),
    cost: Number((item.cost * costScale).toFixed(1)),
...
export const deviceInsights: Record<string, Omit<DeviceInsight, "dataStatus">> = {
  ...
  "ct-01": {
    ...
    peerRank: 2, peerCount: 18, monthly: scaledMonthly(0.83, 0.83, 8), patientSources: [{ name: "门诊", value: 39 }, { name: "住院", value: 34 }, { name: "急诊", value: 20 }, { name: "体检", value: 7 }],
  ...
  "robot-01": {
    ...
    peerRank: 7, peerCount: 8, monthly: scaledMonthly(0.79, 1.23, -33), patientSources: [{ name: "住院", value: 91 }, { name: "门诊", value: 5 }, { name: "急诊", value: 4 }],
  ...
  "linac-01": {
    ...
    peerRank: 5, peerCount: 9, monthly: scaledMonthly(1.12, 1.17, -5), patientSources: [{ name: "住院", value: 66 }, { name: "门诊", value: 29 }, { name: "其他", value: 5 }],
  ...
  "ultrasound-01": {
    ...
    peerRank: 1, peerCount: 26, monthly: scaledMonthly(0.52, 0.53, 5), patientSources: [{ name: "门诊", value: 52 }, { name: "住院", value: 27 }, { name: "体检", value: 15 }, { name: "急诊", value: 6 }],
  ...
  "bio-01": {
    ...
    peerRank: 2, peerCount: 14, monthly: scaledMonthly(0.65, 0.72, 1), patientSources: [{ name: "门诊", value: 46 }, { name: "住院", value: 38 }, { name: "急诊", value: 10 }, { name: "体检", value: 6 }],
    actions: [{ title: "优化夜间急诊样本优先级规则", owner: "检验科", due: "08-02", status: "进行中" }],
  },
  "mri-02": {
    deviceId: "mri-02",
    scores: { economic: 80, efficiency: 84, quality: 90, experience: 80, reliability: 86 },
    standardWorkload: 25960, activeHours: 6.6, uptimeRate: 82.1, loadRate: 77.4, idleRate: 22.6, peakShare: 60.8,
    positiveRate: 66.4, enhancementRate: 29.8, reportQualityRate: 96.8, repeatRate: 1.5,
    appointmentWaitDays: 2.8, onSiteWaitMinutes: 24, reportHours: 2.9, totalJourneyHours: 4, satisfaction: 92.1,
    availabilityRate: 96.2, failuresPer1000Hours: 3, downtimeHours: 38, mttrHours: 5.9, pmCompletionRate: 100, pmPassRate: 95,
    peerRank: 4, peerCount: 12, monthly: scaledMonthly(0.87, 0.82, -2), patientSources: [{ name: "门诊", value: 44 }, { name: "住院", value: 30 }, { name: "急诊", value: 12 }, { name: "体检", value: 9 }, { name: "其他", value: 5 }],
    actions: [{ title: "开放周六上午骨关节专项检查时段", owner: "医学影像科", due: "08-20", status: "进行中" }],
  },
  "mri-03": {
    deviceId: "mri-03",
    scores: { economic: 62, efficiency: 64, quality: 84, experience: 74, reliability: 58 },
    standardWorkload: 21340, activeHours: 5.9, uptimeRate: 74.6, loadRate: 68.3, idleRate: 31.7, peakShare: 66.2,
    positiveRate: 63.1, enhancementRate: 22.4, reportQualityRate: 95.4, repeatRate: 2.6,
    appointmentWaitDays: 4.8, onSiteWaitMinutes: 31, reportHours: 3.4, totalJourneyHours: 5.2, satisfaction: 88.3,
    availabilityRate: 90.1, failuresPer1000Hours: 6.8, downtimeHours: 126, mttrHours: 14.2, pmCompletionRate: 82, pmPassRate: 88,
    peerRank: 10, peerCount: 12, monthly: scaledMonthly(0.54, 0.6, -11), patientSources: [{ name: "门诊", value: 41 }, { name: "住院", value: 36 }, { name: "急诊", value: 14 }, { name: "体检", value: 9 }],
    actions: [{ title: "脱保后冷头故障按次维修与续保方案比价", owner: "医学装备部", due: "08-25", status: "进行中" }, { title: "普通平扫分流至夜间时段缓解两台 3.0T 压力", owner: "医学影像科", due: "08-30", status: "待确认" }],
  },
  "ct-02": {
    deviceId: "ct-02",
    scores: { economic: 90, efficiency: 95, quality: 89, experience: 72, reliability: 92 },
    standardWorkload: 56180, activeHours: 9.1, uptimeRate: 94.3, loadRate: 89.6, idleRate: 10.4, peakShare: 63.7,
    positiveRate: 60.4, enhancementRate: 30.2, reportQualityRate: 96.9, repeatRate: 1,
    appointmentWaitDays: 4.5, onSiteWaitMinutes: 29, reportHours: 2.1, totalJourneyHours: 3.6, satisfaction: 89.6,
    availabilityRate: 98.4, failuresPer1000Hours: 1.5, downtimeHours: 14, mttrHours: 3.4, pmCompletionRate: 100, pmPassRate: 98,
    peerRank: 1, peerCount: 18, monthly: scaledMonthly(1.01, 0.93, 10), patientSources: [{ name: "门诊", value: 38 }, { name: "住院", value: 33 }, { name: "急诊", value: 19 }, { name: "体检", value: 10 }],
    actions: [{ title: "分流 20% 平扫检查至 64 排 CT 的预约规则", owner: "医学影像科 / 运营部", due: "08-18", status: "进行中" }, { title: "第三台 CT 配置论证数据包准备", owner: "医学装备部", due: "09-10", status: "待确认" }],
  },
  "ct-03": {
    deviceId: "ct-03",
    scores: { economic: 83, efficiency: 88, quality: 86, experience: 85, reliability: 85 },
    standardWorkload: 40040, activeHours: 8.6, uptimeRate: 90.8, loadRate: 81.2, idleRate: 18.8, peakShare: 52.6,
    positiveRate: 64.8, enhancementRate: 18.6, reportQualityRate: 95.9, repeatRate: 1.6,
    appointmentWaitDays: 0.2, onSiteWaitMinutes: 14, reportHours: 1.2, totalJourneyHours: 2.1, satisfaction: 93.4,
    availabilityRate: 96.9, failuresPer1000Hours: 2.4, downtimeHours: 27, mttrHours: 4.6, pmCompletionRate: 98, pmPassRate: 96,
    peerRank: 4, peerCount: 18, monthly: scaledMonthly(0.6, 0.61, 5), patientSources: [{ name: "急诊", value: 58 }, { name: "住院", value: 24 }, { name: "门诊", value: 18 }],
    actions: [{ title: "急诊绿色通道检查优先级规则复核", owner: "急诊医学科 / 医学影像科", due: "08-16", status: "已完成" }],
  },
  "dr-01": {
    deviceId: "dr-01",
    scores: { economic: 85, efficiency: 87, quality: 84, experience: 90, reliability: 88 },
    standardWorkload: 53660, activeHours: 7.9, uptimeRate: 88.6, loadRate: 82.4, idleRate: 17.6, peakShare: 64.5,
    positiveRate: 34.2, enhancementRate: 0, reportQualityRate: 95.1, repeatRate: 2.1,
    appointmentWaitDays: 0.3, onSiteWaitMinutes: 13, reportHours: 0.9, totalJourneyHours: 1.6, satisfaction: 94.6,
    availabilityRate: 98.2, failuresPer1000Hours: 1.6, downtimeHours: 12, mttrHours: 2.9, pmCompletionRate: 100, pmPassRate: 97,
    peerRank: 2, peerCount: 9, monthly: scaledMonthly(0.21, 0.2, 3), patientSources: [{ name: "门诊", value: 72 }, { name: "急诊", value: 15 }, { name: "体检", value: 9 }, { name: "住院", value: 4 }],
    actions: [{ title: "高峰时段双技师排班固化", owner: "医学影像科", due: "08-12", status: "已完成" }],
  },
  "dr-02": {
    deviceId: "dr-02",
    scores: { economic: 78, efficiency: 80, quality: 83, experience: 87, reliability: 86 },
    standardWorkload: 45660, activeHours: 7.2, uptimeRate: 84.9, loadRate: 76.8, idleRate: 23.2, peakShare: 57.4,
    positiveRate: 36.8, enhancementRate: 0, reportQualityRate: 94.8, repeatRate: 2.3,
    appointmentWaitDays: 0.4, onSiteWaitMinutes: 15, reportHours: 1.1, totalJourneyHours: 1.9, satisfaction: 93.2,
    availabilityRate: 97.6, failuresPer1000Hours: 2, downtimeHours: 16, mttrHours: 3.5, pmCompletionRate: 98, pmPassRate: 96,
    peerRank: 4, peerCount: 9, monthly: scaledMonthly(0.18, 0.18, -4), patientSources: [{ name: "住院", value: 64 }, { name: "门诊", value: 28 }, { name: "急诊", value: 8 }],
    actions: [{ title: "床旁摄片与固定机房分工界面梳理", owner: "医学影像科", due: "08-22", status: "进行中" }],
  },
  "dr-03": {
    deviceId: "dr-03",
    scores: { economic: 44, efficiency: 42, quality: 80, experience: 90, reliability: 88 },
    standardWorkload: 12270, activeHours: 2.9, uptimeRate: 51.2, loadRate: 38.6, idleRate: 61.4, peakShare: 78.2,
    positiveRate: 21.4, enhancementRate: 0, reportQualityRate: 94.2, repeatRate: 1.2,
    appointmentWaitDays: 0.1, onSiteWaitMinutes: 8, reportHours: 1.4, totalJourneyHours: 1.7, satisfaction: 95.4,
    availabilityRate: 99.1, failuresPer1000Hours: 0.8, downtimeHours: 4, mttrHours: 1.8, pmCompletionRate: 100, pmPassRate: 99,
    peerRank: 8, peerCount: 9, monthly: scaledMonthly(0.05, 0.09, -37), patientSources: [{ name: "体检", value: 86 }, { name: "门诊", value: 14 }],
    actions: [{ title: "平均单日检查量不足 20 人次，合并门诊时段并开放体检预约", owner: "健康管理中心 / 医学影像科", due: "08-20", status: "进行中" }, { title: "与门诊 DR 错峰共享的排班方案评估", owner: "运营部", due: "09-05", status: "待确认" }],
  },
  "dr-mobile-01": {
    deviceId: "dr-mobile-01",
    scores: { economic: 52, efficiency: 55, quality: 81, experience: 84, reliability: 60 },
    standardWorkload: 9570, activeHours: 3.4, uptimeRate: 58.4, loadRate: 52.7, idleRate: 47.3, peakShare: 44.6,
    positiveRate: 41.6, enhancementRate: 0, reportQualityRate: 94.5, repeatRate: 2.8,
    appointmentWaitDays: 0, onSiteWaitMinutes: 22, reportHours: 1.6, totalJourneyHours: 2.4, satisfaction: 90.8,
    availabilityRate: 91.4, failuresPer1000Hours: 5.9, downtimeHours: 82, mttrHours: 11.6, pmCompletionRate: 84, pmPassRate: 90,
    peerRank: 3, peerCount: 4, monthly: scaledMonthly(0.044, 0.063, -25), patientSources: [{ name: "住院", value: 78 }, { name: "急诊", value: 22 }],
    actions: [{ title: "电池组老化更换与脱保续保方案比价", owner: "医学装备部", due: "08-28", status: "进行中" }],
  },
  "dsa-01": {
    deviceId: "dsa-01",
    scores: { economic: 81, efficiency: 77, quality: 92, experience: 83, reliability: 87 },
    standardWorkload: 3220, activeHours: 6.2, uptimeRate: 78.9, loadRate: 72.5, idleRate: 27.5, peakShare: 69.4,
    positiveRate: 0, enhancementRate: 0, reportQualityRate: 98.2, repeatRate: 0.7,
    appointmentWaitDays: 3.4, onSiteWaitMinutes: 28, reportHours: 5.4, totalJourneyHours: 26.8, satisfaction: 91.2,
    availabilityRate: 97.1, failuresPer1000Hours: 2.2, downtimeHours: 24, mttrHours: 5.2, pmCompletionRate: 100, pmPassRate: 97,
    peerRank: 2, peerCount: 6, monthly: scaledMonthly(0.72, 0.79, -9), patientSources: [{ name: "住院", value: 84 }, { name: "急诊", value: 12 }, { name: "门诊", value: 4 }],
    actions: [{ title: "急诊介入夜间备班响应时限压缩至 30 分钟", owner: "介入医学科", due: "08-15", status: "进行中" }],
  },
  "us-02": {
    deviceId: "us-02",
    scores: { economic: 88, efficiency: 86, quality: 89, experience: 90, reliability: 91 },
    standardWorkload: 23180, activeHours: 7.4, uptimeRate: 86.8, loadRate: 81.6, idleRate: 18.4, peakShare: 55.8,
    positiveRate: 46.2, enhancementRate: 0, reportQualityRate: 96.4, repeatRate: 1.5,
    appointmentWaitDays: 1.6, onSiteWaitMinutes: 18, reportHours: 0.7, totalJourneyHours: 1.8, satisfaction: 94.7,
    availabilityRate: 98.5, failuresPer1000Hours: 1.3, downtimeHours: 9, mttrHours: 2.4, pmCompletionRate: 100, pmPassRate: 98,
    peerRank: 2, peerCount: 26, monthly: scaledMonthly(0.33, 0.28, 1), patientSources: [{ name: "门诊", value: 58 }, { name: "住院", value: 34 }, { name: "急诊", value: 8 }],
    actions: [{ title: "心内科术前超声当日完成率提升至 95%", owner: "超声医学科", due: "08-14", status: "进行中" }],
  },
  "us-03": {
    deviceId: "us-03",
    scores: { economic: 90, efficiency: 89, quality: 88, experience: 92, reliability: 92 },
    standardWorkload: 26290, activeHours: 7.8, uptimeRate: 88.9, loadRate: 83.7, idleRate: 16.3, peakShare: 57.2,
    positiveRate: 38.9, enhancementRate: 0, reportQualityRate: 96.1, repeatRate: 1.3,
    appointmentWaitDays: 1.1, onSiteWaitMinutes: 15, reportHours: 0.5, totalJourneyHours: 1.4, satisfaction: 95.8,
    availabilityRate: 98.8, failuresPer1000Hours: 1.1, downtimeHours: 7, mttrHours: 2.1, pmCompletionRate: 100, pmPassRate: 99,
    peerRank: 3, peerCount: 26, monthly: scaledMonthly(0.34, 0.28, 4), patientSources: [{ name: "门诊", value: 66 }, { name: "住院", value: 22 }, { name: "体检", value: 12 }],
    actions: [{ title: "产科三维筛查号源每周增加 10%", owner: "超声医学科", due: "08-10", status: "已完成" }],
  },
  "us-portable-01": {
    deviceId: "us-portable-01",
    scores: { economic: 41, efficiency: 45, quality: 82, experience: 86, reliability: 89 },
    standardWorkload: 5620, activeHours: 1.8, uptimeRate: 42.6, loadRate: 36.4, idleRate: 63.6, peakShare: 38.2,
    positiveRate: 47.8, enhancementRate: 0, reportQualityRate: 93.6, repeatRate: 2.2,
    appointmentWaitDays: 0, onSiteWaitMinutes: 19, reportHours: 0.8, totalJourneyHours: 1.2, satisfaction: 92.4,
    availabilityRate: 99, failuresPer1000Hours: 0.9, downtimeHours: 3, mttrHours: 1.5, pmCompletionRate: 100, pmPassRate: 98,
    peerRank: 24, peerCount: 26, monthly: scaledMonthly(0.033, 0.052, -31), patientSources: [{ name: "住院", value: 92 }, { name: "急诊", value: 8 }],
    actions: [{ title: "制定 ICU 床旁超声使用规范与带教计划", owner: "重症医学科", due: "08-25", status: "进行中" }, { title: "评估调拨至急诊医学科共享使用", owner: "医学装备部 / 运营部", due: "09-15", status: "待确认" }],
  },
  "endo-gastro-01": {
    deviceId: "endo-gastro-01",
    scores: { economic: 82, efficiency: 83, quality: 90, experience: 79, reliability: 87 },
    standardWorkload: 14780, activeHours: 6.9, uptimeRate: 82.7, loadRate: 78.9, idleRate: 21.1, peakShare: 61.3,
    positiveRate: 44.6, enhancementRate: 0, reportQualityRate: 97.4, repeatRate: 1.1,
    appointmentWaitDays: 6.2, onSiteWaitMinutes: 32, reportHours: 0.8, totalJourneyHours: 3.8, satisfaction: 90.6,
    availabilityRate: 96.4, failuresPer1000Hours: 2.6, downtimeHours: 22, mttrHours: 4.4, pmCompletionRate: 98, pmPassRate: 96,
    peerRank: 2, peerCount: 7, monthly: scaledMonthly(0.3, 0.3, -1), patientSources: [{ name: "门诊", value: 62 }, { name: "住院", value: 28 }, { name: "体检", value: 10 }],
    actions: [{ title: "无痛胃镜麻醉时段扩容压缩预约等待", owner: "消化内镜中心 / 手术麻醉科", due: "08-24", status: "进行中" }],
  },
  "endo-colon-01": {
    deviceId: "endo-colon-01",
    scores: { economic: 77, efficiency: 79, quality: 89, experience: 76, reliability: 86 },
    standardWorkload: 11270, activeHours: 6.4, uptimeRate: 79.8, loadRate: 74.6, idleRate: 25.4, peakShare: 63.8,
    positiveRate: 39.4, enhancementRate: 0, reportQualityRate: 97.1, repeatRate: 1.3,
    appointmentWaitDays: 8.4, onSiteWaitMinutes: 35, reportHours: 0.9, totalJourneyHours: 4.2, satisfaction: 89.2,
    availabilityRate: 96, failuresPer1000Hours: 2.9, downtimeHours: 26, mttrHours: 4.9, pmCompletionRate: 98, pmPassRate: 95,
    peerRank: 3, peerCount: 7, monthly: scaledMonthly(0.26, 0.27, -5), patientSources: [{ name: "门诊", value: 58 }, { name: "住院", value: 30 }, { name: "体检", value: 12 }],
    actions: [{ title: "肠道准备宣教线上化降低当日退单率", owner: "消化内镜中心", due: "08-19", status: "进行中" }],
  },
  "lap-01": {
    deviceId: "lap-01",
    scores: { economic: 79, efficiency: 76, quality: 91, experience: 87, reliability: 85 },
    standardWorkload: 1820, activeHours: 5.8, uptimeRate: 74.2, loadRate: 70.6, idleRate: 29.4, peakShare: 66.8,
    positiveRate: 0, enhancementRate: 0, reportQualityRate: 98.3, repeatRate: 0.6,
    appointmentWaitDays: 4.2, onSiteWaitMinutes: 30, reportHours: 5.8, totalJourneyHours: 28.6, satisfaction: 92.2,
    availabilityRate: 96.6, failuresPer1000Hours: 2.5, downtimeHours: 25, mttrHours: 5, pmCompletionRate: 96, pmPassRate: 95,
    peerRank: 3, peerCount: 8, monthly: scaledMonthly(0.34, 0.37, -7), patientSources: [{ name: "住院", value: 95 }, { name: "门诊", value: 5 }],
    actions: [{ title: "镜下器械周转消毒时长压缩 15 分钟", owner: "手术部 / 消毒供应中心", due: "08-21", status: "进行中" }],
  },
  "hema-01": {
    deviceId: "hema-01",
    scores: { economic: 80, efficiency: 84, quality: 93, experience: 90, reliability: 89 },
    standardWorkload: 292000, activeHours: 11.6, uptimeRate: 89.4, loadRate: 79.6, idleRate: 20.4, peakShare: 51.2,
    positiveRate: 18.6, enhancementRate: 0, reportQualityRate: 99.2, repeatRate: 0.7,
    appointmentWaitDays: 0, onSiteWaitMinutes: 10, reportHours: 0.6, totalJourneyHours: 1.1, satisfaction: 95.1,
    availabilityRate: 97.8, failuresPer1000Hours: 1.8, downtimeHours: 19, mttrHours: 3, pmCompletionRate: 100, pmPassRate: 98,
    peerRank: 3, peerCount: 14, monthly: scaledMonthly(0.36, 0.38, -7), patientSources: [{ name: "门诊", value: 48 }, { name: "住院", value: 36 }, { name: "急诊", value: 11 }, { name: "体检", value: 5 }],
    actions: [{ title: "上午采血高峰前置开机自检 30 分钟", owner: "检验科", due: "08-13", status: "已完成" }],
  },
  "vent-01": {
    deviceId: "vent-01",
    scores: { economic: 55, efficiency: 61, quality: 90, experience: 85, reliability: 84 },
    standardWorkload: 6490, activeHours: 15.1, uptimeRate: 63.2, loadRate: 60.4, idleRate: 39.6, peakShare: 41.5,
    positiveRate: 0, enhancementRate: 0, reportQualityRate: 98.8, repeatRate: 0.3,
    appointmentWaitDays: 0, onSiteWaitMinutes: 6, reportHours: 0.4, totalJourneyHours: 0.9, satisfaction: 93.8,
    availabilityRate: 95.2, failuresPer1000Hours: 3.4, downtimeHours: 58, mttrHours: 6.8, pmCompletionRate: 94, pmPassRate: 96,
    peerRank: 5, peerCount: 10, monthly: scaledMonthly(0.11, 0.15, -20), patientSources: [{ name: "住院", value: 88 }, { name: "急诊", value: 12 }],
    actions: [{ title: "呼吸机集中管理与跨病区调配上线", owner: "重症医学科 / 医学装备部", due: "08-29", status: "进行中" }, { title: "老旧 6 台呼吸机延寿评估与替换排期", owner: "医学装备部", due: "09-20", status: "待确认" }],
  },
};
