...
import { canHideMenu, menuCatalog, menuVisibleForPermissions, togglePermissionsForMenu } from "./menu-catalog";
...
export default function AccessControlCenter({
  ...
  function openNewHospital() {
    ...
    setHospitalDraft({ id: `hosp-${Date.now()}`, code: `HOSP-${String(hospitals.length + 1).padStart(3, "0")}`, name: "", shortName: "", level: "三级甲等", category: "综合医院", assetCodePrefix: "", region: "主院区", status: "筹备中", tenantKey: "", dataCompleteness: 0, connectedSources: 0 });
  }
